<div
    class="relative h-screen bg-linear-to-b from-[#102210] via-[#081608] to-[#020502
        ...
        <section class="px-5 pb-25">
            ...
            <form wire:submit.prevent="editTransaksi">
                ...
                <div x-data="{
                    raw: @entangle('amount'),
                    display: ''
                }" x-init="display = raw ? new Intl.NumberFormat('id-ID').format(raw) : '';" class="flex flex-col items-center mb-10">
                    ...
                    <div class="flex items-center">
                        ...
                        <input type="text" x-model="display"
                            ...
                            class="bg-transparent border-none text-4xl font-bold text-white text-center w-52">
                    </div>
                ...
                <div class="glass-input rounded-xl p-4 mb-4">
                    ...
                    <div class="flex gap-3 items-center">
                        ...
                        <input id="title" type="text" wire:model="title"
                            class="bg-transparent border-none focus:ring-0 text-white w-full scheme-dark outline outline-primary/30 py-4 px-2 rounded"
                ...
                <div class="mt-10 flex flex-col gap-5">
                    ...
                    <div x-data="{ deleteModal: false }">
                        ...
                        <button type="button" @click="deleteModal = true"
                            class="text-white/80 w-full h-11 rounded border border-red-500/30 bg-red-500/10 hover:border-red-500 hover:bg-red-500/10 flex items-center justify-center gap-2 font-semibold text-sm">
                            Delete Transaction
                        </button>
                        ...
                        <div x-show="deleteModal" x-transition.opacity x-cloak
                            ...
                            <div @click.outside="deleteModal = false" x-transition.scale
                                ...
                                <div class="flex justify-center gap-3">
                                    ...
                                    <button @click="$wire.deleteHistory(); deleteModal = false" type="button"
