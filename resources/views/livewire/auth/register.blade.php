            ...
            <form wire:submit.prevent="register"
                ...
                <div>
                    ...
                    <div class="relative mt-2">
                        ...
                        <input type="email" wire:model.defer="email" placeholder="name@example.com"
                            class="w-full bg-black/30 rounded py-3 pl-12 pr-4
                                   text-white placeholder-white/30
                                   outline-none focus:ring-1 focus:ring-primary/60 placeholder:text-sm">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative mt-2">
                        <span class="absolute left-4 top-1/2 -translate-y-1/2 text-white/40 material-symbols-outlined" style="font-size: 22px;">
                            lock
                        </span>
                        <input type="password" wire:model.defer="password" placeholder="Create password"
                            class="w-full bg-black/30 rounded py-3 pl-12 pr-4
                                   text-white placeholder-white/30
                                   outline-none focus:ring-1 focus:ring-primary/60 placeholder: text-sm">
                    </div>
                ...
                <!-- Button -->
                <x-button-save>Register</x-button-save>
            </form>
            <!-- FOOTER -->
            <div class="text-center pb-6 text-sm">
                <p class="text-white/60">
                    Already have an account?
                    <a href="{{ route('view-login') }}" wire:navigate class="text-primary font-semibold hover:underline">
                        Log in
                    </a>
                </p>
            </div>
